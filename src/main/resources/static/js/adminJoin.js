...
function checkId() {
    ...
    if(id.value === "") {
        ...
        error[0].innerHTML = "5~20자 영문 대 소문자, 숫자만 사용가능합니다.";
        error[0].style.display = "block";
    } else {
...
function checkClub() {
    var clubPattern = /[a-zA-Z가-힣0-9]{20}/;
    if(club.value === "") {
        error[0].innerHTML = "필수 정보입니다.";
        error[0].style.display = "block";
    } else if(!clubPattern.test(club.value)) {
        error[0].innerHTML = "영문 대 소문자, 숫자, 한글만 사용가능합니다.";
        error[0].style.display = "block";
    } else {
        error[0].innerHTML = "사용가능한 동아리명입니다!";
        error[0].style.color = "#08A600";
        error[0].style.display = "block";
    }
}
...
function comparePw() {
    if(pw2.value === pw1.value && pw2.value != "") {
        pwImg2.src = "/img/joinicon/m_icon_check_enable.png";
        error[2].style.display = "none";
    } else if(pw2.value !== pw1.value) {
        pwImg2.src = "/img/joinicon/m_icon_check_disable.png";
